...
namespace BellaReservations
{
    public partial class receipt : Form
    {
        ...
        public receipt(string reservationId, string customerName, string transportMode, string startPoint, string endPoint, string dateTime, string seatNumbers, string price)
        {
            InitializeComponent();

            // Set the receipt data
            TextBoxReservationId.Text = reservationId;
            TextBoxCustomerName.Text = customerName;
            TextBoxTransportMode.Text = transportMode;
            TextBoxStartingPoint.Text = startPoint;
            TextBoxEndPoint.Text = endPoint;
            TextBoxDateTime.Text = dateTime;
            TextBoxSeatNumbers.Text = seatNumbers;
            LabelTotalAmount.Text = price;
        }
